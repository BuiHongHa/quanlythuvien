"""
Django settings for LMM project.
...
SECRET_KEY = 'django-insecure-u1lxr86e8&dsrpql%xf1ga54+yx3(f!u@oihb862gdy@p29aq)'
...
WSGI_APPLICATION = 'LMM.wsgi.application'
...
# ✓ FIX: CORS - Chỉ cho phép localhost (SAFE)
